        ...
        if (guided) {
            ...
            if (typesResponse.isSuccess) {
                ...
                if ((awaitInput({ s: String ->
                    ...
                    cfg.setJvmArgs(
                        ("-Xms" + memoryInput + " -Xmx" + memoryInput + " --add-modules=jdk.incubator.vector" +
                ...
                if (acceptInput.equals("y", true) || acceptInput.equals("true", true) || acceptInput.equals(
                        "accept",
                        true
                    )
                ) {
                    ...
                    println("\nYou need to accept the eula to start a minecraft server!")
                    exitProcess(0)
                }
